...
#pragma omp parallel for collapse(2) default(none) shared(image_y_size, image_x_size, aspect_ratio, fov_scale, camera_to_world, image, camera_x_pos, camera_y_pos, camera_z_pos, far_clip, objects, objects_length, lights, lights_length, origin)
